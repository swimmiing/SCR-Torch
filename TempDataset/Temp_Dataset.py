...
class TempDataset(Dataset):
    def __init__(self, data_path, split, is_train=True, input_resolution=None):
        super(TempDataset, self).__init__()

        # self.SAMPLE_RATE = 16000
        self.split = split
        # self.set_length = set_length
        self.csv_dir = 'TempDataset/metadata/' + split + '.csv'
        ...
        ''' Image files '''
        self.image_path = os.path.join(data_path)
